      ...
      <section className="rounded-xl border bg-white p-5 shadow-sm">
        ...
        {activeTab === "application_settings" ? (
          <div className="space-y-4">
            ...
            <p className="text-xs text-gray-500">
              Master switch for public access to /apply. Optional dates further constrain access.
            </p>
        ...
        {activeTab === "signup_day" ? (
          <div className="space-y-4">
            ...
            <p className="text-xs text-gray-500">
              Signup day is displayed to applicants and admins for planning. It does not by itself open or close public /apply.
            </p>
